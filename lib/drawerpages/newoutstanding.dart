...
class _OutstandingDataState extends State<OutstandingData> {
  ...
  Future<void> _createPDF() async {
    ...
    //Currency INR
    element = PdfTextElement(
        text: 'Currency :' + products2[0]["CODECURN"].toString(),
        font: timesRoman);
    element.brush = PdfBrushes.black;
    result = element.draw(
        page: page,
        bounds: Rect.fromLTWH(425, result.bounds.bottom + 10, 0, 0))!;
...
//Adds cell customizations
    ...
    // PdfTextElement element1 = PdfTextElement(
    //     text: "Customer ID :" + products2[0]["IDCUST"].toString(),
    //     font: subHeadingFont);
...
//Draws the grid to the PDF page
    ...
    gridResult.page.graphics.drawString(
        'Total Outstanding Amount: INR  ' + products2[0]["AMTDUETC"].toString(),
        subHeadingFont,
